...
# Rozpakowanie recovery.img
../magiskboot unpack ../r.img
../magiskboot cpio ramdisk.cpio extract

# Reverse fastbootd ENG mode check — poprawione ścieżki
...
# Dodanie zmodyfikowanego recovery do ramdisku
../magiskboot cpio ramdisk.cpio 'add 0755 system/bin/recovery system/bin/recovery'

# Spakowanie zmodyfikowanego obrazu
